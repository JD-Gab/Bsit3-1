...
<section class="vh-100" style="background-image: linear-gradient(to bottom right, #AED2FF, #9400FF);
}">
          ...
          <div class="card-body p-md-5">  
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color: #865DFF">LOGIN</p>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="img/loginpic.jpg" class="img-fluid" alt="Sample image">
